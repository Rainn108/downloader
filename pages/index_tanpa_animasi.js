...
export default function Home({ triggerAd }) {
  ...
  const renderContent = () => {
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
            ...
            <div className="flex-1 text-center md:text-left space-y-2 w-full">
              ...
              <button
                ...
                className="w-full md:w-auto mt-4 px-6 py-2.5 bg-blue-500 hover:bg-blue-600 active:scale-95 text-white rounded-md font-medium transition-all flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
              >
      ...
      return (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-4 gap-2 text-center text-xs text-slate-600">
            <div className="bg-slate-50 p-2 rounded-md border border-slate-100 transition-all hover:-translate-y-1">
                         ...
                         {noWmVideo && (
                            <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-black/20 transition-all">
                                <button 
                                    ...
                                    className="bg-white/20 backdrop-blur-sm p-3 rounded-md text-white hover:bg-white/30 active:scale-90 transition-all border border-white/50"
                                >
          ...
          <div className="grid gap-3">
            {noWmVideo && (
              <button
                ...
                className="w-full py-2.5 bg-blue-500 text-white rounded-md font-medium flex items-center justify-center gap-2 hover:bg-blue-600 active:scale-95 transition-all shadow-md"
              >
            ...
            {audio && (
              <button
                ...
                className="w-full py-2.5 bg-white text-slate-700 border border-slate-300 rounded-md font-medium flex items-center justify-center gap-2 hover:bg-slate-50 active:scale-95 transition-colors shadow-sm"
              >
    ...
    // Pinterest/Instagram with medias
    if (data.medias) {
                                  ...
                                  {primaryVideo && (
                                      <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-black/20 transition-all">
                                          <button 
                                              ...
                                              className="bg-white/20 backdrop-blur-sm p-4 rounded-md text-white hover:bg-white/30 active:scale-90 transition-all border border-white/50"
                                          >
             ...
             <div className="space-y-2">
               {data.medias.map((res, idx) => (
                 <button
                   ...
                   className="w-full flex items-center justify-between p-3 bg-white border border-slate-200 rounded-md hover:border-blue-400 hover:shadow-md hover:translate-x-1 transition-all group"
                 >
          ...
          {data.map((item, idx) => (
            ...
            >
              ...
              <button
                ...
                className="w-full py-2 bg-white border border-blue-500 text-blue-600 rounded-md font-medium text-sm hover:bg-blue-50 active:scale-95 transition-all flex items-center justify-center gap-2 shadow-sm"
              >
    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-[#F8FAFC]">
        ...
        <div className="w-full max-w-lg space-y-6 z-10">
          ...
          <div className="bg-white/80 backdrop-blur-md p-2 rounded-2xl shadow-xl border border-white/50">
              ...
              <button
                  ...
                  className="absolute right-1.5 p-3 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white rounded-xl transition-all disabled:bg-slate-300 shadow-md"
              >
        ...
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 md:top-auto md:left-1/2 md:bottom-auto md:-translate-x-1/2 md:translate-y-0 md:my-auto bg-white/90 backdrop-blur-xl rounded-t-2xl md:rounded-2xl shadow-2xl z-50 w-full md:max-w-xl max-h-[90vh] overflow-y-auto border border-white/20">
              <div className="sticky top-0 bg-white/80 backdrop-blur-md border-b border-slate-100 p-5 flex justify-between items-center z-20">
                  ...
                  <button 
                     onClick={() => setData(null)} 
                     className="p-2 hover:bg-slate-100 active:scale-90 rounded-full text-slate-500 transition-all"
                  >
                      <X size={20} />
                  </button>
              </div>
      ...
      {activePreview && activePreview.type === 'image' && (
        ...
        >
          <button 
            onClick={() => setActivePreview(null)}
            className="absolute top-4 right-4 p-2 bg-white/10 hover:bg-white/20 active:scale-90 rounded-full text-white transition-all"
          >
            <X size={24} />
          </button>
          <img 
